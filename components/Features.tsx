...
function Features() {
  return (
    <>
              ...
              <div className="self-stretch h-72 flex-col justify-start items-start gap-4 flex">
                ...
                <div className="self-stretch h-[248px] flex-col justify-start items-start gap-6 flex">
                  ...
                  <div className="self-stretch text-black text-lg font-normal font-['Roboto'] leading-[27px]">
                    Our platform empowers users to connect with peers and
                    mentors, share valuable resources, and build comprehensive
                    profiles. Stay updated with opportunity alerts that keep you
                    informed about the latest advancements in your field.
                  </div>
                </div>
              </div>
              <div className="self-stretch h-[132px] flex-col justify-start items-start gap-4 flex">
                <div className="self-stretch py-2 justify-start items-start gap-6 inline-flex">
                  <div className="grow shrink basis-0 flex-col justify-start items-start gap-4 inline-flex">
                    <div className="self-stretch text-black text-xl font-bold font-['Roboto'] leading-7">
                      Subheading one
                    </div>
      ...
      <div className="w-full h-[942px] px-16 py-28 bg-white flex-col justify-start items-center gap-20 inline-flex">
        <div className="h-[234px] flex-col justify-start items-center gap-4 flex">
          ...
          <div className="self-stretch h-[194px] flex-col justify-start items-center gap-6 flex">
            <div className="self-stretch text-center text-black text-5xl font-bold font-['Roboto'] leading-[57.60px]">
              Explore Our Exciting Features for Learning
            </div>
            <div className="self-stretch text-center text-black text-lg font-normal font-['Roboto'] leading-[27px]">
              ...
              educational journey. From tracking your progress to connecting
              with mentors, we have everything you need to succeed.
            </div>
          </div>
        </div>
          ...
          <div className="self-stretch h-[276px] justify-start items-start gap-12 inline-flex">
            <div className="grow shrink basis-0 flex-col justify-start items-center gap-6 inline-flex">
              ...
              <div className="self-stretch h-[156px] flex-col justify-start items-center gap-6 flex">
                ...
                <div className="self-stretch text-center text-black text-base font-normal font-['Roboto'] leading-normal">
                  Showcase your skills and track your progress against peers.
                </div>
              </div>
            </div>
            <div className="grow shrink basis-0 flex-col justify-start items-center gap-6 inline-flex">
              ...
              <div className="self-stretch h-[156px] flex-col justify-start items-center gap-6 flex">
                <div className="self-stretch text-center text-black text-[32px] font-bold font-['Roboto'] leading-[41.60px]">
                  Find Your Perfect Mentorship Opportunity
                </div>
                <div className="self-stretch text-center text-black text-base font-normal font-['Roboto'] leading-normal">
            ...
            <div className="grow shrink basis-0 flex-col justify-start items-center gap-6 inline-flex">
              ...
              <div className="self-stretch h-[156px] flex-col justify-start items-center gap-6 flex">
                ...
                <div className="self-stretch text-center text-black text-base font-normal font-['Roboto'] leading-normal">
                  Access a wealth of knowledge and tools from fellow users.
                </div>
              </div>
            </div>
          </div>
